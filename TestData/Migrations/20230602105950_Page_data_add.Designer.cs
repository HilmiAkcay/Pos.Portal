...
namespace CloudData.Migrations
{
    ...
    [Migration("20230602105950_Page_data_add")]
    partial class Page_data_add
    {
            ...
            modelBuilder.Entity("CloudDomain.Domain.Application", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(184),
                            ExeName = "Giftcard.exe",
                            IsAssignable = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(197),
                            Name = "PurePOSGiftcardService",
                            StartAfterInstall = false,
                            StartMode = 0,
                            UID = new Guid("8a7513ff-ef1d-457d-852a-d8436693da23")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.Shop", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(433),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(436),
                            Name = "Default Shop",
                            ShopGroupId = 1L,
                            UID = new Guid("5dd4a5f0-e4ab-4ab7-a67f-6e9ea2bea828")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.ShopGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(415),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(417),
                            Name = "Default Group",
                            UID = new Guid("0cb9c57a-fbed-4ffd-b718-79435806f688")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(455),
                            Email = "admin@posmanager.nl",
                            IsDeleted = false,
                            IsValidated = true,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(456),
                            Password = "PoS666",
                            RememberMe = true,
                            ShopId = 1L,
                            UID = new Guid("7542d38f-e810-4682-a3a3-0161b1d0723f")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Page", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(473),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(474),
                            Name = "Users",
                            PurePosId = 2,
                            UID = new Guid("fa822607-d891-4219-a424-263096a3bc08")
                        },
                        new
                        {
                            ID = 3L,
                            CreatedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(492),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 6, 2, 13, 59, 50, 8, DateTimeKind.Local).AddTicks(493),
                            Name = "User Setting",
                            PurePosId = 3,
                            UID = new Guid("af711b87-fc1d-4735-9c6f-eb6aa054d665")
                        });
                });
