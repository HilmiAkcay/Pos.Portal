...
namespace CloudData.Migrations
{
    ...
    [Migration("20230717211158_Admin_user_add")]
            ...
            modelBuilder.Entity("CloudDomain.Domain.Application", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5152),
                            ExeName = "Giftcard.exe",
                            IsAssignable = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5164),
                            Name = "PurePOSGiftcardService",
                            StartAfterInstall = false,
                            StartMode = 0,
                            UID = new Guid("87fb83df-1e37-48fc-8b23-bd84fa84b9b3")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.Shop", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5380),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5386),
                            Name = "Default Shop",
                            ShopGroupId = 1L,
                            UID = new Guid("2c722719-3f12-45c1-9f60-9d7ff8e54deb")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.ShopGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5363),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5364),
                            Name = "Default Group",
                            UID = new Guid("9bcaad6b-2437-40cc-913e-c87e1a7be919")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5404),
                            Email = "admin@posmanager.nl",
                            IsDeleted = false,
                            IsValidated = true,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5406),
                            Password = "PoS666",
                            RememberMe = true,
                            ShopId = 1L,
                            UID = new Guid("42d5fcfc-f5fd-4898-be67-c474063b4499")
                        },
                        new
                        {
                            ID = 2L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5417),
                            Email = "admin",
                            IsDeleted = false,
                            IsValidated = true,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5418),
                            Password = "1",
                            RememberMe = true,
                            ShopId = 1L,
                            UID = new Guid("6d0f201e-31b7-41fa-8ece-332372e915be")
                        });
                });
            ...
            modelBuilder.Entity("CloudDomain.Page", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5424),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5425),
                            Name = "Users",
                            PurePosId = 2,
                            UID = new Guid("76515f8c-3cf7-4fd1-aeb7-8ea72cecb76e")
                        },
                        new
                        {
                            ID = 3L,
                            CreatedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5438),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2023, 7, 18, 0, 11, 58, 533, DateTimeKind.Local).AddTicks(5439),
                            Name = "User Setting",
                            PurePosId = 3,
                            UID = new Guid("b88a2b64-bdcb-4735-b09f-ca1d946f4205")
                        });
                });
